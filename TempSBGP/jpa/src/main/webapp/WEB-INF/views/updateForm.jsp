...
<body>
  ...
  <form action="/update"  method="post" "multipart/form-data" >
    <label for="fname">Food Id</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input type="text"  name="prodid" value="<%=product.getId() %>" readonly><br><br>

    <label for="lname">FoodName</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input type="text"  name="prodname" value="<%=product.getName() %>"><br><br>
    
    <label for="lname">FoodCatagory</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <input type="text"  name="catagory" value="<%=product.getCatagory()%>" readonly><br><br>
